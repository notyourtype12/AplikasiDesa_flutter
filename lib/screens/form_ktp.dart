...
class FormKtp extends StatefulWidget {
  ...
  @override
  State<FormKtp> createState() => _FormAktaState();
}

class _FormAktaState extends State<FormKtp> {
  ...
  File? _foto1; // foto kk
  File? _foto2; // foto ijazah
  File? _foto3; // akta kelahiran
  ...
  Future<void> _loadUserData() async {
   ...
   Future<void> _submitForm() async {
    ...
    request.fields['id_surat'] = 'S2025-006';
        ...
        child: Column(
          children: [
           ...
           buildUploadField('Kartu Keluarga', _foto1, (file) {
            ...
            buildUploadField('Foto Ijazah Terakhir', _foto2, (file) {
              setState(() => _foto2 = file);
            }),
            const SizedBox(height: 16),

            buildUploadField('Akta Kelahiran', _foto3, (file) {
