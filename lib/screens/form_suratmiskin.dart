...
class FormSuratmiskin extends StatefulWidget {
  const FormSuratmiskin({super.key});

  @override
  State<FormSuratmiskin> createState() => _FormSuratmiskinState();
}

class _FormSuratmiskinState extends State<FormSuratmiskin> {
  ...
  File? _foto1; // foto kk
  File? _foto2; // foto ktp
  File? _foto3; // foto rumah tampak depan 
  File? _foto4; // foto rumah samping kanan
  File? _foto5; // foto rumah samping kiri
  File? _foto6; // foto rumah tampak dapur
  File? _foto7; // foto rumah tampak kamar mandi
  File? _foto8; // foto akta kelahiran
  ...
  Future<void> _submitForm() async {
    ...
    request.fields['id_surat'] = 'S2025-007';
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
             buildUploadField('Foto Kartu Keluarga)', _foto1, (file) {
              setState(() => _foto1 = file);
            }),
            const SizedBox(height: 16),

           buildUploadField('Foto KTP', _foto2, (file) {
              setState(() => _foto2 = file);
            }),
            const SizedBox(height: 16),

           buildUploadField('Foto Rumah Tampak Depan', _foto3, (file) {
              setState(() => _foto3 = file);
            }),
            const SizedBox(height: 16),

            buildUploadField('Foto Rumah Tampak Samping Kanan', _foto4, (file) {
              setState(() => _foto4 = file);
            }),
            const SizedBox(height: 16),

            buildUploadField('Foto Rumah Tampak Samping Kiri', _foto5, (file) {
              setState(() => _foto5 = file);
            }),
            const SizedBox(height: 16),

            buildUploadField('Foto Rumah Tampak Dapur', _foto6, (file) {
              setState(() => _foto6 = file);
            }),

            const SizedBox(height: 16),
            buildUploadField('Foto Rumah Tampak Kamar Mandi', _foto7, (file) {
              setState(() => _foto7 = file);
            }),
            const SizedBox(height: 16),

            buildUploadField('Akta Kelahiran', _foto8, (file) {
